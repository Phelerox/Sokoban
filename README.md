...
* A file called `src/routes/about.svelte` corresponds to the `/about` route. A file called `src/routes/levels/[slug].svelte` corresponds to the `/levels/:slug` route, in which case `params.slug` is available to the route
